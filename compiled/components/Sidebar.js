...
function Sidebar({ activeTab, setActiveTab, currentUser, allUsers, onSwitchUser, onRequestSwitch, menuConfig, isOpen, onClose, }) {
    ...
    const renderItem = (item, sub) => {
        ...
        const Icon = isLink
            ...
            : ICONS[navId] ?? ICONS[item.id] ?? lucide_react_1.Layers;
